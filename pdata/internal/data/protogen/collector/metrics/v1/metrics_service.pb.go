...
const file_opentelemetry_proto_collector_metrics_v1_metrics_service_proto_rawDesc = "" +
	...
	"\x06Export\x12E.opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceRequest\x1aF.opentelemetry.proto.collector.metrics.v1.ExportMetricsServiceResponse\"\x00B\xc0\x01\n" +
	"+io.opentelemetry.proto.collector.metrics.v1B\x13MetricsServiceProtoP\x01ZOgo.opentelemetry.io/collector/pdata/internal/data/protogen/collector/metrics/v1\xaa\x02(OpenTelemetry.Proto.Collector.Metrics.V1b\x06proto3"
