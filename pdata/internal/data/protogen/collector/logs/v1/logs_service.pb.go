...
const file_opentelemetry_proto_collector_logs_v1_logs_service_proto_rawDesc = "" +
	...
	"\x06Export\x12?.opentelemetry.proto.collector.logs.v1.ExportLogsServiceRequest\x1a@.opentelemetry.proto.collector.logs.v1.ExportLogsServiceResponse\"\x00B\xb4\x01\n" +
	"(io.opentelemetry.proto.collector.logs.v1B\x10LogsServiceProtoP\x01ZLgo.opentelemetry.io/collector/pdata/internal/data/protogen/collector/logs/v1\xaa\x02%OpenTelemetry.Proto.Collector.Logs.V1b\x06proto3"
