...
type ExportTraceServiceRequest struct {
	...
	xxx_hidden_ResourceSpans *[]*v1.ResourceSpans   `protobuf:"bytes,1,rep,name=resource_spans,json=resourceSpans,proto3"`
...
type ExportTraceServiceResponse struct {
	state                     protoimpl.MessageState     `protogen:"opaque.v1"`
	xxx_hidden_PartialSuccess *ExportTracePartialSuccess `protobuf:"bytes,1,opt,name=partial_success,json=partialSuccess,proto3"`
	unknownFields             protoimpl.UnknownFields
	sizeCache                 protoimpl.SizeCache
}
...
type ExportTracePartialSuccess struct {
	state                    protoimpl.MessageState `protogen:"opaque.v1"`
	xxx_hidden_RejectedSpans int64                  `protobuf:"varint,1,opt,name=rejected_spans,json=rejectedSpans,proto3"`
...
func (x *ExportTracePartialSuccess) GetRejectedSpans() int64 {
	if x != nil {
		return x.xxx_hidden_RejectedSpans
	}
	return 0
}
...
func (b0 ExportTracePartialSuccess_builder) Build() *ExportTracePartialSuccess {
	m0 := &ExportTracePartialSuccess{}
	b, x := &b0, m0
	_, _ = b, x
	x.xxx_hidden_RejectedSpans = b.RejectedSpans
...
const file_opentelemetry_proto_collector_trace_v1_trace_service_proto_rawDesc = "" +
	...
	"\x06Export\x12A.opentelemetry.proto.collector.trace.v1.ExportTraceServiceRequest\x1aB.opentelemetry.proto.collector.trace.v1.ExportTraceServiceResponse\"\x00B\xb8\x01\n" +
	")io.opentelemetry.proto.collector.trace.v1B\x11TraceServiceProtoP\x01ZMgo.opentelemetry.io/collector/pdata/internal/data/protogen/collector/trace/v1\xaa\x02&OpenTelemetry.Proto.Collector.Trace.V1b\x06proto3"
