...
func (ms DoubleGauge) DataPoints() NumberDataPointSlice {
...
func (ms DoubleSum) DataPoints() NumberDataPointSlice {
	return newNumberDataPointSlice(&(*ms.orig).DataPoints)
}
...
// NumberDataPoint is a single data point in a timeseries that describes the time-varying value of a int or double metric.
//
// This is a reference type, if passed by value and callee modifies it the
// caller will see the modification.
//
